...
Welcome::oneLoopIterationn(){
}

Welcome::buttonPress(char b){
...
Activity::oneLoopIterationn(){
}

Activity::buttonPress(char b){
}
//------------------------------------------------------------------------------
...
Standby::oneLoopIterationn(){
}

Standby::buttonPress(char b){
}
//------------------------------------------------------------------------------
...
void OpenSebem::pointsByNumberOfTries(int t){
    switch (t) {
    case 0:
        return 10;
    case 1:
